...
| `seoPath` | string | no (stamped on shards) | Public canonical path `/islands/{nation}/{slug}/` from `scripts/seo_paths.py`. Not hand-edited; regenerated by `build_islands_index.py`. |
