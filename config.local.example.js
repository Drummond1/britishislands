// Copy to config.local.js (gitignored). Load via <script src="config.local.js"></script> in index.html.
// Restrict the OS key to your site origin in https://osdatahub.os.uk/
