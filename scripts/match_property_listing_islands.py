...
ALIASES: dict[tuple[str, str], str] = {
    ...
    ("eilean loch oscair", "Scotland"): "osm-way-205056852",
    ("inishskehan island", "Ireland"): "osm-relation-3395358",
    ("inishturk south", "Ireland"): "osm-relation-5763894",
    ("trannish island", "Northern Ireland"): "osm-relation-3516655",
    ("trannish", "Northern Ireland"): "osm-relation-3516655",
    ("cruit island", "Ireland"): "osm-relation-9126999",
    ("garric s ait", "England"): "osm-way-157810927",
    ("wheatley s eyot", "England"): "osm-way-157812309",
    ("wheatleys eyot", "England"): "osm-way-157812309",
    ("bryher", "England"): "osm-relation-3217444",
    ("st martin s", "England"): "osm-relation-3210701",
    ("st martin s scilly", "England"): "osm-relation-3210701",
    ("menawethan", "England"): "osm-relation-3210701",
    ("bryher", "England"): "osm-relation-3217444",
...
HINT_RULES: list[tuple[re.Pattern, str]] = [
    ...
    (re.compile(r"st martin.*scilly|menawethan", re.I), "osm-relation-3210701"),
    (re.compile(r"bryher.*scilly|jenford", re.I), "osm-relation-3217444"),
    (re.compile(r"st agnes.*scilly|coastguard.*scilly", re.I), "osm-relation-3198786"),
    (re.compile(r"hugh town|st mary.*scilly", re.I), "scilly-st-marys"),
