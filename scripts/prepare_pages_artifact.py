...
def main() -> None:
    ...
    for forced in (
        ...
        ROOT / "about",
        ROOT / "methodology",
        ROOT / "editorial-policy",
        ROOT / "corrections",
        ROOT / "sources-licensing",
        ROOT / "contact",
        ROOT / "dataset",
        ROOT / "sitemap.xml",
        ROOT / "sitemap-core.xml",
        ROOT / "sitemap-islands-editorial.xml",
        ROOT / "sitemap-islands.xml",
        ROOT / "sitemap-ferries-verified.xml",
        ROOT / "sitemap-collections.xml",
        ROOT / "robots.txt",
        ROOT / "llms.txt",
    ):
